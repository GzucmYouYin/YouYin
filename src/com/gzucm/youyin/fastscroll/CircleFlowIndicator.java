 ...
 */
package com.gzucm.youyin.fastscroll;
...
//	private boolean mCentered = false;
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		initColors(0xff7fd53e, 0xffd1d1d1, STYLE_FILL, STYLE_STROKE);
	}
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int activeDefaultColor = 0xff7fd53e;
		...
		int inactiveDefaultColor = 0xffd1d1d1;
